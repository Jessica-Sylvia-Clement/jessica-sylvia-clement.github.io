...
function MoreInfoCard({ title, subtitle, link, description, image }) {
  const CardContent = (
    <div className="flex flex-col justify-start items-center border border-green-700 rounded-lg p-4 shadow-md cursor-pointer hover:scale-102 transition-transform duration-300 hover:shadow-[0_0_15px_2px_rgba(34,197,94,0.5)] h-full">
      {/* Image */}
      {image && (
