...
function SkillCard({ title, icon: Icon, items, shadowColor, badgeStyle = false }) {
  return (
    <div
      className={`flex flex-col justify-center items-center border border-green-700 rounded-lg p-6 shadow-md cursor-pointer hover:scale-102 transition-transform duration-300`}
    >
      {/* Icon */}
