    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white px-6">
      ...
      <div className="flex flex-col justify-center gap-6 max-w-4xl w-full">
        ...
        <a
          ...
          className="flex flex-col items-center rounded-lg p-6 shadow-[0_0_15px_2px_rgba(255,215,0,0.5)] hover:scale-102 transition-transform hover:shadow-[0_0_20px_4px_rgba(255,215,0,0.8)]"
        >
        ...
        <a
          ...
          className="flex flex-col items-center rounded-lg p-6 shadow-[0_0_15px_2px_rgba(0,119,181,0.5)] hover:scale-102 transition-transform hover:shadow-[0_0_20px_4px_rgba(0,119,181,0.7)]"
        >
